...
export type UiCopy = {
  ...
  request: {
    ...
    chooseService: string; chooseCountry: string; next: string; previous: string; review: string; submit: string;
  ...
  adminPages: {
    ...
    leads: {
      ...
      source: string; actions: string; convert: string; deleteConfirm: string; page: string; result: string;
  ...
  adminLogin: {
    ...
    verify: string; verifying: string; back: string; employeeBarcode: string; employeeLogin: string;
  };
...
const overrides: Record<Exclude<Lang, "ar" | "en">, DeepPartial<UiCopy>> = {
  ...
  id: {
    ...
    auth: { clientTitle: "Portal klien", clientSubtitle: "Masuk untuk melihat permintaan Anda", login: "Masuk", email: "Alamat email", password: "Kata sandi", forgot: "Lupa kata sandi?", noAccount: "Belum punya akun?", create: "Buat akun", registerTitle: "Buat akun Anda", registerSubtitle: "Gabung ke portal klien OFOQ", fullName: "Nama lengkap", phone: "Nomor telepon", confirmPassword: "Konfirmasi kata sandi", createAccount: "Buat akun", haveAccount: "Sudah punya akun?", invalid: "Email atau kata sandi tidak valid", forgotTitle: "Lupa kata sandi Anda?", forgotSubtitle: "Masukkan email Anda dan kami akan mengirimkan tautan pemulihan", checkEmail: "Periksa email Anda", checkEmailDesc: "Jika email ini terdaftar pada kami, Anda akan menerima tautan reset dalam beberapa menit.", spam: "Periksa folder spam jika tidak terlihat.", backLogin: "Kembali ke masuk", sendReset: "Kirim tautan pemulihan", sending: "Mengirim...", resetTitle: "Tetapkan kata sandi baru", resetSubtitle: "Pilih kata sandi yang kuat untuk akun Anda", passwordChanged: "Kata sandi berhasil diubah", redirecting: "Anda akan segera dialihkan ke halaman masuk.", goLogin: "Langsung ke masuk", newPassword: "Kata sandi baru", passwordStrength: "Kekuatan", savePassword: "Simpan kata sandi baru", saving: "Menyimpan...", mismatch: "Kata sandi tidak cocok", minPassword: "Kata sandi minimal harus 8 karakter", invalidReset: "Tautan tidak valid atau sudah kedaluwarsa" },
    request: { title: "Permintaan layanan baru", subtitle: "Lengkapi formulir dan tim kami akan menghubungi Anda dalam 24–48 jam", steps: ["Informasi perusahaan", "Detail kontak", "Detail layanan", "Tinjauan"], company: "Nama perusahaan", commercialReg: "Nomor registrasi komersial (opsional)", activity: "Bidang usaha", contactEmail: "Email kontak", contactPhone: "Nomor telepon", service: "Layanan yang diminta", package: "Paket (opsional)", country: "Negara perekrutan (jika berlaku)", notes: "Catatan tambahan (opsional)", chooseService: "Pilih layanan...", chooseCountry: "Pilih negara...", next: "Berikutnya", previous: "Sebelumnya", review: "Tinjau permintaan", submit: "Kirim permintaan", success: "Permintaan Anda berhasil dikirim.", error: "Permintaan tidak dapat dikirim.", required: "Wajib" },
